            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
                        ...
                        <div>
                            <ul class="row">
                                <li class="col-lg-6"><i class="icofont-rounded-right"></i> <strong>Ulang Tahun :</strong> <?=$data['dob']?></li>
                                <li class="col-lg-6"><i class="icofont-rounded-right"></i> <strong>Email :</strong> <?=$data['emailid']?></li>
                                <li class="col-lg-5"><i class="icofont-rounded-right"></i> <strong>No HP :</strong> <?=$data['mobile']?></li>
...
-->
            <div class="credits">
                Developed by <a href="#">pujacoding</a>
            </div>
        </div>
    </footer><!-- End  Footer -->
